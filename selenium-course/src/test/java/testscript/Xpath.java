...
public class Xpath extends Base{
	public void xpathTypes() {
		...
		WebElement xChild4 = driver.findElement(By.xpath("//li[@class='list-group-item']//child::a"));
 		...
 		WebElement xFollow = driver.findElement(By.xpath("//button[@id='button-one']//following::div"));
 		
 		WebElement xPreced = driver.findElement(By.xpath("//button[@id='button-one']//preceding::div"));
 		
 		WebElement xDescendant = driver.findElement(By.xpath("//div[@class='row']//descendant::a"));
 		
 		WebElement xFollowSiblings = driver.findElement(By.xpath("//label[@for='inputEmail4']//following-sibling::input"));
